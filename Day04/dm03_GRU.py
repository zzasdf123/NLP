...
def dm1_GRU():
    ...
    #参2：hidden_size:GRU单元输出的隐藏层张量的维度
    #参3：num_layers:有几层GRU单元（有几个隐藏层）
    input_size = 5
    hidden_size = 6
    num_layers = 2
    ...
    #3.获取h0输入
    # h0的参数说明
    # 参1：num_layers:有几层GRU单元（有几个隐藏层）
    # 参2：batch_size:GRU单元输出的隐藏层张量的维度
    # 参3:hidden_size:GRU单元输出的隐藏层张量的维度
    h0 = torch.randn(num_layers,batch_size,hidden_size)
    #4.将输入送给GRU模型得到下一时间步输出结果
    output,h0 = model(x0,h0)
